...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-metro-rush-super-secret-key-arcade-2026-runner')
...
# Database
# Default: SQLite for immediate plug-and-play local execution
DATABASES = {
    'default': {
